                ...
                <div className="mt-8 py-6 items-center justify-between sm:flex">
                    ...
                    <div className="mt-6 sm:mt-0" data-aos="fade-left">
                        <ul className="flex items-center space-x-4">
                            <li className="w-10 h-10 border rounded-full flex items-center justify-center" data-aos="zoom-in" data-aos-delay="100">
                                <a href="/" aria-label="Twitter">
                                    <svg className="svg-icon w-6 h-6 text-gray-600 hover:text-gray-900" viewBox="0 0 20 20">
                            ...
                            <li className="w-10 h-10 border rounded-full flex items-center justify-center" data-aos="zoom-in" data-aos-delay="200">
